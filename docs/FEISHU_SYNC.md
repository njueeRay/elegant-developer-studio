...
本文件记录飞书 Wiki 空间、节点、文档 token 和重复同步流程。

## 语言规则

- 飞书知识库首选语言为中文。
- 英文只保留在代码路径、组件名、API、品牌名、外部链接标题和必要专有名词中。
- 本地 Markdown 是事实源；同步飞书前必须先更新本地中文文档。

## 空间信息

| 字段 | 值 |
| --- | --- |
| 名称 | Elegant Developer Studio｜个人主页项目知识库 |
| Space ID | `7650170980995697842` |
| 根导航节点 | `UYrLwuB1AieALIk9VKOcnLzqnwb` |
| 根导航文档 | `KCW7dozh6oGfDnx7wk3cyn98nId` |
| 根导航 URL | `https://scnlb1lk96sb.feishu.cn/wiki/UYrLwuB1AieALIk9VKOcnLzqnwb` |

## 节点地图

| 页面 | 本地源文件 | Wiki node | Doc token | URL |
| --- | --- | --- | --- | --- |
...
| 01｜项目地图 | `docs/PROJECT_MAP.md` | `PG7ew3DRviyumekYTSec9n4znWf` | `V3fTd13AjoI98AxNiwrcA6pFnMd` | https://scnlb1lk96sb.feishu.cn/wiki/PG7ew3DRviyumekYTSec9n4znWf |
...
| 04｜信息架构 | `docs/INFORMATION_ARCHITECTURE.md` | `H8O7wIK0pibqivk6SIAcp72Xnob` | `CQwGdvs8Bo9RQ0xz2z2cILN3nFb` | https://scnlb1lk96sb.feishu.cn/wiki/H8O7wIK0pibqivk6SIAcp72Xnob |
| 05｜设计系统 | `docs/DESIGN_SYSTEM.md` | `HrgcweuFCiL5E8kOdQPcOsXtnyg` | `DHzvdCwnzoS2NSxc9bXcfPrZnKd` | https://scnlb1lk96sb.feishu.cn/wiki/HrgcweuFCiL5E8kOdQPcOsXtnyg |
| 06｜开发进度 | `docs/PROGRESS_LOG.md` | `CKEKwH6vriYZMOkyPnDcDMvYn1d` | `WIu3dCr7AoUnkXxHqtAcDMjqnwA` | https://scnlb1lk96sb.feishu.cn/wiki/CKEKwH6vriYZMOkyPnDcDMvYn1d |
| 07｜决策记录 | `docs/DECISIONS.md` | `D67twGhp5izbt1kk7olc6TyunZf` | `DsUEd7yA2oYyJcx3jQ3csOUenkh` | https://scnlb1lk96sb.feishu.cn/wiki/D67twGhp5izbt1kk7olc6TyunZf |
| 08｜版本追溯 | `docs/VERSION_TRACE.md` | `G8nwwns5ii1JZtkw77GcB5Y0nob` | `BryQdzxSYo7EEEx0fOVcaawUnec` | https://scnlb1lk96sb.feishu.cn/wiki/G8nwwns5ii1JZtkw77GcB5Y0nob |
| 09｜质量验收 | `design-qa.md` | `HLO5waemhiXD24kyfuXc7WXFnGe` | `XH7LdiZmHoRY0BxRIDicFqeNnwh` | https://scnlb1lk96sb.feishu.cn/wiki/HLO5waemhiXD24kyfuXc7WXFnGe |
| 10｜素材与参考 | `docs/ASSETS_REFERENCE.md` | `BTdhw9uB9iLBuik767Gcjiv7nUb` | `XrE5d5QQIonKp3xVXrrcdsskneg` | https://scnlb1lk96sb.feishu.cn/wiki/BTdhw9uB9iLBuik767Gcjiv7nUb |
| 11｜执行复核 | `docs/EXECUTION_REVIEW.md` | `VkYEwYWeli09ZTkDtxYchYyHn1f` | `O55Hd84DUoYCq2xMKNJcbQTBnmd` | https://scnlb1lk96sb.feishu.cn/wiki/VkYEwYWeli09ZTkDtxYchYyHn1f |
...
2. 本地检查和提交。
3. 推送到 GitHub。
4. 使用 `docs +update --command overwrite` 更新飞书文档。
5. 抓取飞书文档并验证关键文本。
6. 如果节点或 doc token 变化，更新本文件。
...
- `docs +update --command overwrite` 会移除已有媒体块。
- 覆盖素材页后必须重新插入这些图片。
